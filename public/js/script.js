...
const firebaseConfig = {
  apiKey: "AIzaSyC0DnJ-mh34zCPTVPhCYWUjW5SiGmdPr7c",
  authDomain: "evox-card.firebaseapp.com",
  projectId: "evox-card",
  storageBucket: "evox-card.appspot.com",
  messagingSenderId: "21012312456",
  appId: "1:21012312456:web:77c28befacf8d809fc440f"
};

// Initialize Firebase
// Only initialize if Firebase is not already initialized (prevents duplicate initialization)
...
function initAboutInteraction() {
    ...
    if (!interactionScene || !phoneMockup || !cardMockup || !connectionAnimation) return;
